...
@NamedQueries({
    ...
    , @NamedQuery(name = "Floorplan.findById2", query = "SELECT f.shelfname, f.shape, f.location, f.level FROM Floorplan as f WHERE f.id = :id")   
    , @NamedQuery(name = "Floorplan.findByShelfname", query = "SELECT f FROM Floorplan f WHERE f.shelfname = :shelfname")
    , @NamedQuery(name = "Floorplan.findByIdnName", query = "SELECT f FROM Floorplan f WHERE f.id = :id AND f.shelfname = :shelfname")        
